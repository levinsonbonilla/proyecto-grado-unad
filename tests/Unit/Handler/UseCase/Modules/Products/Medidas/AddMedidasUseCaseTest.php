...
class AddMedidasUseCaseTest extends TestCase
{
    ...
    private AddMedidasUseCase $useCase;

    protected function setUp(): void
    {
        $this->form = $this->createMock(FormInterface::class);
        $this->form->method('handleRequest')->willReturnSelf();
        $this->form->method('getName')->willReturn('medidas');
        ...
        $this->useCase = new AddMedidasUseCase(
            $this->requestStack,
            $this->formFactory,
            $this->log,
            $this->translator,
    ...
    public function testHandlerWithValidFormCreatesMedida(): void
    {
        $data = ['name' => 'M'];

        $this->form->method('isSubmitted')->willReturn(true);
        $this->form->method('isValid')->willReturn(true);
        $this->request->method('get')->with('medidas', [])->willReturn($data);

        $this->entityManager->expects($this->once())->method('add');
        $this->translator->method('trans')->willReturn('Medida creada');
