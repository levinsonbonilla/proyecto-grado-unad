...
class CountriesCategoriesRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry, private readonly CacheInterface $cache)
    {
        parent::__construct($registry, CountriesCategories::class);
    }
    ...
    public function getSelectedIds(Categories $entity, bool $useCache = true): array
    {
        ...
        return $this->cache->get(
            "categories_country_ids_{$entity->getId()}",
    ...
    {
        $this->cache->delete("categories_country_ids_{$entity->getId()}");
    }
}
