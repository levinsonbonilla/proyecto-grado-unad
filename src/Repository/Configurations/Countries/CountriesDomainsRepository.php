...
class CountriesDomainsRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry, private readonly CacheInterface $cache)
    {
        parent::__construct($registry, CountriesDomains::class);
    }
    ...
    public function getSelectedIds(Domains $entity, bool $useCache = true): array
    {
        ...
        return $this->cache->get(
            "domains_country_ids_{$entity->getId()}",
    ...
    {
        $this->cache->delete("domains_country_ids_{$entity->getId()}");
    }
}
